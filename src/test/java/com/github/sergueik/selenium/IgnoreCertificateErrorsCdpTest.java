...
public class IgnoreCertificateErrorsCdpTest extends BaseCdpTest {

	private static String baseURL = "https://untrusted-root.badssl.com/";
	private final String selector = "#footer";

	private static String command = "Security.setIgnoreCertificateErrors";
	...
	// @Ignore("appears broken in DOM navigation")
	...
	public void test2() {
		...
		try {
			...
			String data = result.get("outerHTML").toString();
			assertThat(data, containsString(
					"The certificate for this site is signed using an untrusted root."));
			System.err.println(data);
