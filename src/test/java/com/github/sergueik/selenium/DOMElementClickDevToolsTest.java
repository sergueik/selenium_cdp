...
import org.openqa.selenium.devtools.v123.dom.model.Quad;
	...
	public void test1() {
		try {
			...
			results.subList(0, 1).forEach(nodeId -> {
				...
				// org.openqa.selenium.devtools.v123.dom.model.Quad
				...
				// org.openqa.selenium.devtools.v123.dom.model.Quad
				// at
				// org.openqa.selenium.devtools.v123.dom.model.Quad.fromJson(Quad.java:18)
