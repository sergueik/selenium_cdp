...
import org.openqa.selenium.devtools.v139.dom.model.Quad;
	...
	public void test1() {
		try {
			...
			results.subList(0, 1).forEach(nodeId -> {
				System.err.println(String.format("Id: %s\nHTML: %s", nodeId.toString(), chromeDevTools
						.send(DOM.getOuterHTML(Optional.of(nodeId), Optional.empty(), Optional.empty()))));
				// NOTE: WARNING: Unable to map result for DOM.getContentQuads
				// org.openqa.selenium.json.JsonException:
				// Unable to create instance of class
				// org.openqa.selenium.devtools.v139.dom.model.Quad
				...
				// class org.openqa.selenium.devtools.v139.dom.model.Quad
