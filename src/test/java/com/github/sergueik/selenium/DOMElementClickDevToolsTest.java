...
import org.openqa.selenium.devtools.v153.dom.model.Quad;
	...
	public void test1() {
		try {
			...
			results.subList(0, 1).forEach(nodeId -> {
				...
				// org.openqa.selenium.devtools.v153.dom.model.Quad
				...
				// class org.openqa.selenium.devtools.v153.dom.model.Quad
