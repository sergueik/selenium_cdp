...
import org.openqa.selenium.devtools.v121.dom.DOM.EnableIncludeWhitespace;
import org.openqa.selenium.devtools.v121.dom.DOM.PerformSearchResponse;
import org.openqa.selenium.devtools.v121.dom.model.Node;
import org.openqa.selenium.devtools.v121.dom.model.NodeId;
import org.openqa.selenium.devtools.v121.dom.model.Quad;
	...
	public void test1() {
		try {
			...
			results.subList(0, 1).forEach(nodeId -> {
				...
				// org.openqa.selenium.devtools.v121.dom.model.Quad
				...
				// org.openqa.selenium.devtools.v121.dom.model.Quad
				// at
				// org.openqa.selenium.devtools.v121.dom.model.Quad.fromJson(Quad.java:18)
