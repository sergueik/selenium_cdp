...
public class RemoreDriverTest {
	...
	public static void setUp() {
		...
		if (runHeadless) {
			...
			// https://groups.google.com/g/selenium-users/c/uqZ4_9INuFs
			// driver = new Augmenter().augment(driver);
			// for accessing devTools of RemoteDriver
			// NOTE also, for clustered grid
			// https://groups.google.com/g/selenium-users/c/EM7MmUN7Js0
